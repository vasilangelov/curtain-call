...
<head>
    ...
    <title>{{ $title }} - Curtain Call</title>
...
<footer id="footer" class="footer"
        style="background-image: url('/assets/img/home/seats.jpg'); background-position: bottom center;">

    <div class="footer-content position-relative">
        <div class="container">
            <div class="footer-info text-center ">
                <h3>Curtain Call</h3>
                <p class="text-uppercase">Social media links</p>
